...
<OPTIONS Product="VetPartners New User Creation" Version="1.2">
 <Settings>
...
function Call-ANUC_pff {
	...
	$formMain.Text = "VetPartners New User Creation"
